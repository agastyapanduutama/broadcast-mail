...
class C_pangkat extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('admin/M_pangkat', 'pangkat');
    }
    ...
    function update()
    {
        ...
        if ($this->pangkat->update($data, [$this->req->encKey('id') => $id]) == true) {
            $msg = array(
                'status' => 'ok',
    ...
    function delete($id)
    {
        if ($this->pangkat->delete([$this->req->encKey('id') => $id]) == true) {
            $msg = array(
                'status' => 'ok',
    ...
    {
        if ($action == 'on') {
            if ($this->pangkat->update(['status' => '1'], $this->req->id($id)) == true) {
                $msg = array(
                    'status' => 'ok',
            ...
            if ($this->pangkat->update(['status' => '0'], $this->req->id($id)) == true) {
                $msg = array(
                    'status' => 'ok',
    ...
    function allOff()
    {
        ...
        foreach ($idNa as $id) {
            if ($id != "") {
                if ($this->pangkat->update(['status' => 0], $this->req->id($id)) == true) $jmlNa++;
            }
        }
        if ($jmlNa > 0) {
            echo json_encode([
    ...
    function allOn()
    {
        ...
        foreach ($idNa as $id) {
            if ($id != "") {
                if ($this->pangkat->update(['status' => 1], $this->req->id($id)) == true) $jmlNa++;
            }
        }
        if ($jmlNa > 0) {
            echo json_encode([
    ...
    function allDelete()
    {
        ...
        foreach ($idNa as $id) {
            if ($id != "") {
                if ($this->pangkat->delete($this->req->id($id)) == true) $jmlNa++;
            }
        }
        if ($jmlNa > 0) {
            echo json_encode([
