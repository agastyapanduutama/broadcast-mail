...
<div class="card">
    <div class="card-body">
        <div class="table-responsive">
            <table id="list_pangkat" class="table table-striped table-bordered" style="width:100%">
                <thead>
                    <tr>
            ...
            <form id="formAddpangkat">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_pangkat" id="pangkat" class="form-control" required>
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <form id="formEditpangkat">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Nama pangkat</label>
                        <input type="text" name="nama_pangkat" id="pangkat1" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Keterangan</label>
